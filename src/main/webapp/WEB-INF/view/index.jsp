            ...
            <%--<ul class="nav navbar-nav">--%>
                ...
                <%--<security:authorize access="hasAnyRole('ROLE_ADMIN', 'ROLE_USER')">--%>
                    <%--<li>--%>
                        ...
                        <%--&lt;%&ndash;УБРАЛ ФОРМУ КОТОРАЯ НИЖЕ,&ndash;%&gt;--%>
                        <%--&lt;%&ndash;ЧТО Б НОРМ ВЫГЛЯДЕЛО, &ndash;%&gt;--%>
                        <%--&lt;%&ndash;ИБО КНОПКА ВЫГЛЯДЕЛА КОНЧЕНО, &ndash;%&gt;--%>
                        <%--&lt;%&ndash;LOGOUT РАБОТАЕТ НОРМАЛЬНО, ПРОВЕРИШЬ))&ndash;%&gt;--%>
